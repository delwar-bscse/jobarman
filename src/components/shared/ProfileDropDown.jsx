    ...
    <>
      {data ? (
        <div className="relative" ref={dropdownRef}>
          ...
          <div className={`absolute right-0 mt-2 w-44 lg:w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden transition-all duration-200 ease-out
